...
Chapter 3 vocabulary | `pass` |:sparkling_heart: the action of placing the variable used as an argument in the parentheses of the function call; sometimes used as a synonym for calling a function
