...
General discussion |`Standards or preferences` |Examples:<br>:sparkling_heart: mu vs other IDEs (VSCode, PyCharm, etc)<br>:arrow_right: this is a matter of preference/comfort/use-case<br>:sparkling_heart: snake_case vs camelCase<br>:arrow_right: standard laid out in [PEP8](https://www.python.org/dev/peps/pep-0008/)<br>:sparkling_heart: `import random` vs `from random import randint` vs `from random import *`<br>:arrow_right: also laid out in [PEP8](https://www.python.org/dev/peps/pep-0008/)|
